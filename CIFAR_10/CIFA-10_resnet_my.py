# reference :
# https://github.com/KellerJordan/ResNet-PyTorch-CIFAR10/blob/master/main.py
import argparse
...
from model_pytorch import ResNet
...
def main(args):
    ...
    # train model
    SCHEDULE_EPOCHS = [3, 5, 5]  # divide lr by 10 after each number of epochs
