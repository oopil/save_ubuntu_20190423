...
parser.add_argument('--input_nc', dest='input_nc', type=int, default=256, help='# of input image channels')
parser.add_argument('--output_nc', dest='output_nc', type=int, default=256, help='# of output image channels')
