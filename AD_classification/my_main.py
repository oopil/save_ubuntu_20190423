...
parser.add_argument('--train_size', dest='train_size', type=int, default=370, help='# images used to train')
parser.add_argument('--load_size', dest='load_size', type=int, default=256, help='scale images to this size')
parser.add_argument('--fine_size', dest='fine_size', type=int, default=256, help='then crop to this size')
parser.add_argument('--ngf', dest='ngf', type=int, default=2, help='# of gen filters in first conv layer')
parser.add_argument('--ndf', dest='ndf', type=int, default=2, help='# of discri filters in first conv layer')
...
parser.add_argument('--which_direction', dest='which_direction', default='MtoP', help='AtoB or BtoA')
...
parser.add_argument('--gen_model', dest='gen_model', default='res_2', help='choose generation network')
parser.add_argument('--discirim_model', dest='discrim_model', default='disc_my', help='choose generation network')
parser.add_argument('--use_lsgan', dest='use_lsgan', type=bool, default=True, help='gan loss defined in lsgan')
parser.add_argument('--max_size', dest='max_size', type=int, default=0, help='max size of image pool, 0 means do not use image pool')
